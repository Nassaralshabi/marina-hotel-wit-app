...
class EmployeesListActivity : AppCompatActivity(), EmployeesAdapter.EmployeeListener {
    ...
    private fun refreshSummary(list: List<EmployeeUi>) {
        ...
        binding.employeeCount.text = getString(R.string.employee_count_format, list.size)
        binding.activeEmployees.text = getString(R.string.active_count_format, activeCount)
    }
